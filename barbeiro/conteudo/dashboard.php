      ...
      <a href="http://localhost/sistema_barbearia/barbearia.php?id=<?php echo $idBarbearia?>">http://localhost/sistema_barbearia/barbearia.php?id=<?php echo $idBarbearia?></a>
        ...
        <!-- <div class="mt-5 mb-5 pb-5 container-fluid">
            ...
            <div class="graph-body col-12">
                <p class="pt-2 pb-2">
                    <span><i class="fas fa-money-bill-wave"></i> Serviços diarios  (EM DESENVOLVIMENTO)</span>
                </p>
                <hr class="hr-dif">
                <p class="mt-1 mb-1">
        ...
        <!-- <div class="mt-5 pb-5 container-fluid">
            ...
            <div class="graph-body col-12">
                <p class="pt-2 pb-2">
                    <span><i class="fas fa-money-bill-wave"></i> Lucro mensal (EM DESENVOLVIMENTO)</span>
                </p>
                <hr class="hr-dif">
                <p class="mt-1 mb-1">
                    <i class="fas fa-clock"></i> Atualizado a x minutos atras
